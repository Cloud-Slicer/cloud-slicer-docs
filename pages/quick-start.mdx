...
6. ## Make Your First Set of API Calls ##
   ...
   **Queue your first quote:**
   ...
   Slicing can take anywhere from a few seconds to a couple of minutes, so quotes are async — you queue a job, then poll until it's ready.
   ...
   **Poll until it's ready:**
   ...
   :::note
   For a step-by-step code walkthrough (Python and TypeScript) of this same flow, see [Creating Quotes](/guides/creating-quotes).
   :::
