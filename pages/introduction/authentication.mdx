...
Or in the [API playground](https://api.cloudslicer3d.com/docs), paste your token into the authorization modal (lock icon) to authenticate your session.  See how you can get started with our **API Playground** in the [Quickstart Guide](/quick-start#authenticate-with-the-api).
